            ...
            <div className="profile__details">
                ...
                <div className="social_details">
                    ...
                    <div className="follow__details">
                        <div className="followers"><span className="tag">{data.followers}</span><br />Followers</div>
                        <div className="following"><span className="tag">{data.following}</span><br />Following</div>
                    </div>
                </div>
                <div className="bio">
                    <p className='bio__line'>{data.bio}</p>
                    <a href={data.instagram} rel="noreferrer" target='_blank' className='instagram'>{data.instagram}</a>
                </div>
